...
Open http://localhost:5180 — click to capture the mouse, then **WASD** to move, **mouse** to aim, **click** to shoot.
...
```
src/game.ts   — scene, player, input, camera, shooting
...
- [x] Shooting (hitscan) + dummy targets
- [ ] NPC enemies that shoot back
- [ ] Multiplayer server
